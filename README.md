...
#  About this tool
CountAlleles counts the number of alleles in a VCF file. It uses a BAM file to ensure the alleles have
a minimum quality.

#  Documentation
For documentation and manuals visit the [readthedocs page](http://biopet-countalleles.readthedocs.io/en/latest/).
